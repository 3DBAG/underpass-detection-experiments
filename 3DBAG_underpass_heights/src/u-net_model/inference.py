...
def pred_show_image_grid(data_path, model_path, device):
    ...
    image_dataset = UnderpassDataset(data_path, test=True)
    images = []
    orig_masks = []
    pred_masks = []
...
if __name__ == "__main__":
    # SINGLE_IMG_PATH = r"D:\internship\u-net_model\data\manual_test\image1.jpg"
    DATA_PATH = r"C:\Users\juang\Desktop\TUDelft\Q6\internship\implementation\underpass-detection-experiments\3DBAG_underpass_heights\src\u-net_model\data"
    MODEL_PATH = r"C:\Users\juang\Desktop\TUDelft\Q6\internship\implementation\underpass-detection-experiments\3DBAG_underpass_heights\src\u-net_model\model.pth"
