...
EDGE_CLASSIFICATION_SNAP_TOLERANCE=0.001               # Grid size for snapping (ST_SnapToGrid)
EDGE_CLASSIFICATION_SNAP_ADJACENT_TOLERANCE=0.1        # Tolerance for snapping adjacent buildings (ST_Snap)
```
